...
has never been China's strong point
[update: The US AG indicted Huawei with theft of trade secrets and financial fraud.
See section below: link:#huawei-indictments[Huawei Indictments]]
], so I'd take this proffering of advice with
a pinch of salt:
...
=== How people get caught on TOR

Adrian Crenshaw, "How Tor Users Got Caught - Defcon 22", published by DEFCONConference,
29 Dec 2014 on YouTube.
Available: https://www.youtube.com/watch?v=eQ2OZKitRwc(link:https://www.defcon.org/images/defcon-22/dc-22-presentations/Crenshaw/DEFCON-22-Adrian-Crenshaw-Dropping-Docs-on-Darknets-How-People-Got-Caught-UPDATED.pdf[slides])

=== Huawei indictments

Huawei was hit with 2 separate indicments on 28 Jan 2019:

. CR19-010 RSM Huawei Theft of Trade Secrets Conspiracy
(link:https://www.justice.gov/opa/pr/chinese-telecommunications-device-manufacturer-and-its-us-affiliate-indicted-theft-trade[press release]
/link:https://www.justice.gov/opa/press-release/file/1124996/download[indictment])
(link:{assetdir}/huawei_indictment_pacer_0-tmobile.pdf[pdf])
. CR18-457 Huawei/Meng Wanzhou
(link:https://www.justice.gov/opa/pr/chinese-telecommunications-conglomerate-huawei-and-huawei-cfo-wanzhou-meng-charged-financial[press release]
/link:https://www.justice.gov/opa/press-release/file/1125021/download[indictment])
(link:{assetdir}/huawei_et_al._indictment__0-skycom.pdf[pdf])

==== Notes on the climate surrounding the indictments

- Indictments were announced by AG Whittaker,
whose appointment as AG and refusal to recuse himself from the ongoing Russia probe has been
link:https://edition.cnn.com/2018/12/20/politics/matthew-whitaker-attorney-general-robert-mueller-investigation/index.html[controversial].
- The US is currently engaged in a
link:https://www.scmp.com/topics/us-china-trade-war[trade war] with China.
- The Trump administration
link:https://www.nytimes.com/2018/12/19/us/politics/sanctions-oleg-deripaska-russia-trump.html[lifted sanctions] against Deripaska,
against the advice of his own officials.

[start=1]
* Post-hoc:
** China arrested
link:https://www.nytimes.com/2018/12/14/world/canada/china-detained-spavor-kovrig.html[Canadian businesspersons].
** Belligerence and denial by the Chinese government + Chinese ambassadors.
*** https://twitter.com/joannachiu/status/1084961287639986177
*** Michael Peel and Alex Barker, "China envoy to EU hits out at Huawei security ‘slander’",
published 28 Jan 2019 on _Financial Times_. Available: https://www.ft.com/content/fbb7a49c-20c8-11e9-b126-46fc3ad87c65
(link:{assetdir}/china-hits-out-eu.pdf[pdf])
+
[quote]
____
...
____
*** China's ambassasor to Canada accuses Canada and allies of "white supremacy":
...
==== Huawei-T-mobile Theft of trade secrets conspiracy

Indictment explicitly details crime, intent, and fraud.

. Establishes that Tappy is a trade secret, protected with "reasonable" (imo, more than reasonable) measures.
. Shows correspondence between actors from Huawei USA, Huawei China, and Huawei leadership,
all with the intent (with explicit knowledge of wrongdoing)
to steal tech from T-mobile.
. This includes one of the named actors in the indictment literally taking a robot arm and putting it into his bag
to surreptitiously measure and photograph the instrument.
. Huawei continually tried to access the restricted area in question depite T-mobile explicit denial of access,
which includes a pass revocation after Huawei USA and China employees have repeatedly accessed in an unauthorized
manner the restricted facility.
. After the theft was discovered, Huawei repeatedly denied and misrepresented the extent of the theft.
. The denials were made around the same time Huawei China had "launched a formal policy instituting a bonus 
program to reward employees who stole confidential information from competitors."
. The indictment includes details from email correspondence between Huawei employees, and reports/photographs exchanged.
